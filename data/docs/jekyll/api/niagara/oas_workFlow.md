...
### GET /work-flows - *Fetch Workflows*
...
```json
{
  ...
  "_links": {
    "next": {
      "href": "https://api.example.com/work-flows?limit=42&offset=next-offset"
    },
    "self": {
      "href": "https://api.example.com/work-flows?limit=42"
    }
  }
}
```
...
### GET /work-flows/{workflow_id}/contexts - *Fetch contexts for workflow*

<a id="opIdfetchContextsForWorkflow"></a>

*Fetch contexts for workflow*
...
|entity_id|body|string|false|Customer identifier|
        ...
        anyOf:
          - $schema: http://json-schema.org/draft-07/schema#
            ...
            description: Require the user confirm an action. This is normally used when
              Niagara cannot automatically detect that a task or action has been
              performed.
            properties:
              label:
                &a6
