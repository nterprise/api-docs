...
<h3 id="createunit-parameters">Parameters</h3>
...
|»»» part_number|body|string|false|The part number supplied by the vendor|
...
<h3 id="createunit-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|A unit response|Inline|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad Request|Inline|
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|Inline|
|403|[Forbidden](https://tools.ietf.org/html/rfc7231#section-6.5.3)|Forbidden|Inline|

<h3 id="createunit-responseschema">Response Schema</h3>
...
<h3 id="fetchunitbyid-responses">Responses</h3>
...
<h3 id="fetchunitbyid-responseschema">Response Schema</h3>
...
<h3 id="updateunit-parameters">Parameters</h3>
...
<h3 id="updateunit-responses">Responses</h3>
...
<h3 id="updateunit-responseschema">Response Schema</h3>
...
<a id="opIdpartialUpdateUnit"></a>

`PATCH /units/{unit_id}`

*Updates part of unit*

Update the current status or current location for a unit
...
<h3 id="partialupdateunit-parameters">Parameters</h3>
...
<h3 id="partialupdateunit-responses">Responses</h3>
...
<h3 id="partialupdateunit-responseschema">Response Schema</h3>
...
This will soft delete the unit
...
<h3 id="deleteunit-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|205|[Reset Content](https://tools.ietf.org/html/rfc7231#section-6.3.6)|Unit deleted|None|
|401|[Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)|Unauthorized|Inline|
|403|[Forbidden](https://tools.ietf.org/html/rfc7231#section-6.5.3)|Forbidden|Inline|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|Resource not found|Inline|
|423|[Locked](https://tools.ietf.org/html/rfc2518#section-10.4)|Forbidden|Inline|

<h3 id="deleteunit-responseschema">Response Schema</h3>
                ...
                anyOf:
                  - type: object
                    description: >-
                      ...
                      values. If the value is not in the list, it will then be
                      ...
                      options:
                        ...
                        properties:
                          ...
                          check_case:
                            type: boolean
                            description: >-
                              Perform a case sensitive match. By default will
                              not match case
                            default: false
                          default:
                            type: string
                  ...
                  - type: object
                    description: >-
                      Filter to transform values into null. This is helpful when
                      trying to make a value required. The following are
                      considered empty:
                  ...
                  - type: object
                    description: >-
                      Add a prefix to the start of a string. If the string
                      already start with the prefix, it will not prepend.
                    required:
                      - type
                      - options
                    properties:
                  ...
                  - type: object
                    ...
                    properties:
                      ...
                      options:
                        ...
                        description: String filter has no options
                  - description: >-
                      Add a suffix to the start of a string. If the string
                      already start with the suffix, it will not append.
                    type: object
                    required:
                      - type
                      - options
            ...
            validators:
              ...
              items:
                anyOf:
                  - type: object
                    description: >-
                      Validate number is between two values. By default, min and
                      max are included
                    required:
                      - type
                      - options
                      ...
                      options:
                        ...
                        properties:
                          strict:
                            type: boolean
                            description: >-
                              Enforce strict standards from ARPA. This will
                              enforce the length of the string
                            default: true
                          lookup:
                            type: boolean
                            description: >-
                              Look up the host name and check if it has a valid
                              MX record
                            default: false
                  - type: object
                    description: Validate string ends with a value
                  ...
                  - type: object
                    description: >-
                      Validate number is greater than a value. By default, this
                      will check if value is greater than or equals to
                    required:
                      - type
                      - options
                    properties:
                  ...
                  - type: object
                    description: >-
                      Validate number is less than a value. By default, this
                      will check if value is less than or equals to
                    required:
                      - type
                      - options
                    properties:
                  ...
                  - type: object
                    description: >-
                      ...
                      options do not have to sync with the step. If they do not
          ...
          items:
            anyOf:
              ...
              - type: object
                description: >-
                  Filter to transform values into null. This is helpful when
                  trying to make a value required. The following are considered
                  empty:
