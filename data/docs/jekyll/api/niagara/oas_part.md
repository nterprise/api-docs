...
|input_filter|body|[object]¦null|true|Input Filters allow custom fields to be defined for entities|
...
|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|A Part HAL response|Inline|
...
### GET /parts/{part_id}/relations - *Fetch Part relations*
...
<h3 id="fetchrelationsforpart-responses">Responses</h3>
...
<h3 id="fetchrelationsforpart-responseschema">Response Schema</h3>
...
### POST /parts/{part_id}/relations - *Create relation*
...
<h3 id="createrelationforpart-responses">Responses</h3>
...
<h3 id="createrelationforpart-responseschema">Response Schema</h3>
...
### DELETE /parts/{part_id}/relations/{relation_id} - *Delete relation for part*

<a id="opIddeleteRelationForPart"></a>

*Delete relation for part*
...
<h3 id="deleterelationforpart-responses">Responses</h3>
...
<h3 id="deleterelationforpart-responseschema">Response Schema</h3>
